...
try:
    df = pd.read_excel('TestData_8May5.xlsx')
except FileNotFoundError:
    print("Failed to find 'TestData_8May5.xlsx'. Please check the file path.")
    raise
...
def generate_exam_desk_cards(data):
    ...
    grouped_data = data.groupby(['Board', 'Venue2', 'Exam Room', 'Session', 'Date'])
